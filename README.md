...
- Merging dataframes to work with the data;
- Cohort analysis to understand user profiles and purchasing behavior;
- User segmentation through:
    - RFM (recency, frequency, monetary) [used for customer segmentation in online stores];
    - And by most purchased products and categories;
    
## Based on the analyses carried out, the main conclusions of the project are:
